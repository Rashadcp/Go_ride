    ...
    return (
        <div className="w-full">
            ...
            <button
                ...
                className="w-full py-5 bg-[#1A1A1A] text-white font-black uppercase tracking-[0.2em] text-[10px] rounded-2xl flex items-center justify-center gap-4 border-none hover:bg-black transition-all active:scale-[0.98] shadow-xl shadow-[#1A1A1A]/20"
            >
                <div className="w-8 h-8 bg-white rounded-xl flex items-center justify-center p-2 font-[family-name:var(--font-roboto)] shrink-0 shadow-sm border border-white/10">
